...
[difftool "smerge"]
    ...
    # Trust the exit code returned by Sublime Merge.
    trustExitCode = true
#+end_src
...
The Emacs configuration assumes that the helper script ~git-ediff~ is available in
your search path.
