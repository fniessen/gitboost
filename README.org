...
#+begin_src conf
    ...
    missing = "!f() { \
        ...
        printf \"$(tput bold)$(tput setaf 2)You have %d extra commits:\n\" \
            \"$commits_missing_to_current\"; \
        git --no-pager log \"$OTHER_BRANCH\"..\"$current_branch\"; \
        printf \"\n\n$(tput bold)$(tput setaf 3)You are missing %d commits:\n\" \
            \"$commits_missing_to_other\"; \
