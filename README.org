...
Select a diff tool to visualize the differences.
...
Commonly used tools include ~vimdiff~, ~meld~, ~kdiff3~, ~tkdiff~, etc. Choose one
according to your preference and availability.
