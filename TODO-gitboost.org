...
#+SETUPFILE: ~/org/setup/html-theme-bigblow.setup

* Tasks

** TODO Vérifier git unmodify et unadd

Vérifier que 'git unmodify' et 'git unadd' existent et fonctionnent bien

** TODO Set upstream track style in alias br

Use white bold on red background color for the 'upstream track' param in alias
'br'
...
** MAYB Review teachgit helper

See function teachgit in
https://github.com/matthewmccullough/dotfiles/blob/master/shellactivities

** MAYB CircleCI overview
...
** TODO Review alias collection

Check out other aliases
...
** TODO Review Git power routines

Look at Git Power Routines [course]

https://www.youtube.com/playlist?list=PLDshL1Z581YYxLsjYwM25HkIYrymXb7H_

** TODO Learn Git basics
...
** TODO Emacs Git quick start

Git Quick Start For Emacs Devs
